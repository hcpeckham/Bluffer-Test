...
//*****FIRST ATTEMPT W/ IMAGE BEHIND****
//        UIView.transitionWithView(readyViewController.view, duration: 1.0, options: .TransitionFlipFromRight, animations: { () -> Void in
//            self.readyViewController.view.addSubview(self.guessViewController.view)
//            }) { (finished) -> Void in
//                self.guessViewController.view.removeFromSuperview()
//                self.readyViewController.presentViewController(self.guessViewController, animated: false, completion: nil)
//        }
